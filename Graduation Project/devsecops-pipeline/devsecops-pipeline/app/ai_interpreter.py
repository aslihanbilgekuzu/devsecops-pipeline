...
def interpret_findings(bandit_result: dict, pip_audit_result: dict, code_snippet: str = "", flake8_result: dict = None, gitleaks_result: dict = None, semgrep_result: dict = None) -> dict:
...
Semgrep SAST findings: {json.dumps(semgrep_result or {}, indent=2)}
